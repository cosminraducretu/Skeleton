<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="CustomerLogin" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblError" runat="server" ForeColor="#FF3300" style="z-index: 1; left: 595px; top: 291px; position: absolute"></asp:Label>
