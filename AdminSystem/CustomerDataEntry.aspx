...
<body style="height: 570px; width: 740px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 162px; top: 487px; position: absolute" Text="Cancel" BackColor="#FFCCCC" height="35px" width="90px" OnClick="btnCancel_Click" />
