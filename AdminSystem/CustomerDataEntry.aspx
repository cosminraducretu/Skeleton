...
<body style="height: 570px; width: 740px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="BtnOK_Click" style="z-index: 1; left: 49px; top: 487px; position: absolute; width: 51px; right: 1385px;" Text="OK" BackColor="#99CCFF" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 120px; top: 487px; position: absolute" Text="Cancel" BackColor="#FFCCCC" />
        <asp:Button ID="BtnFind" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 199px; top: 487px; position: absolute; height: 22px; width: 44px;" Text="Find" BackColor="#CCFF66" />
    </form>
</body>
</html>
